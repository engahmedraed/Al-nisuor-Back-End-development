...
--
-- Host: localhost:3306
-- Generation Time: Sep 07, 2021 at 03:57 PM
...
(20, '{\"ops\":[{\"insert\":\"dscfsrt\\n\"}]}', '{\"ops\":[{\"insert\":\"sdfe4t\\n\"}]}', '{\"ops\":[{\"insert\":\"ergve45t\\n\"}]}', '{\"ops\":[{\"insert\":\"asferd\\n\"}]}', '{\"ops\":[{\"insert\":\"wetfge\\n\"}]}', '{\"ops\":[{\"insert\":\"wefgvr\\n\"}]}', 27, '2021-09-04 15:58:31', 0),
...
(1, 'testtestetstetstetstets22', 'test@gamil.com22', 'test', 'test', '2021-09-05 18:41:03', '2021-09-05 18:46:10', 0),
...
CREATE TABLE `faqs` (
  `id` int NOT NULL,
  `ar_question` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ar_answer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `en_question` varchar(255) DEFAULT NULL,
  `en_answer` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(7, 'اي استطيع ان اعرف متى يبدا العام الدراسي لسنة ٢٠٢١ - ٢٠٢؟', 'ان التقويم الجامعي هو تقويم يعَد من قبل وزارة التعليم العالي والبحث العلمي والذي يضم المواعيد الجامعية للاطلاع.', 'That is, can I know when the school year 2021-2022 begins?', 'The university calendar is a calendar prepared by the Ministry of Higher Education and Scientific Research, which includes university dates for viewing', '2021-08-25 07:22:43', '2021-08-31 15:06:51', 0),
(8, 'اين اجد الجدول الالكتروني للاقسام ؟', 'يمكنكم الوصل للجداول الالكترونية عن طريق الرابط https://e-learn.nuc.edu.iq/dashboard/index', 'Where can I find the  E-table for the departments?', 'You can link to the E-tables via the link https://e-learn.nuc.edu.iq/dashboard/index', '2021-08-31 15:01:11', '2021-08-31 15:01:11', 0),
(9, 'من اين استطيع الحصول على الايميل الجامعي ؟', 'تستطيع ان تراجع شعبة الاعلام و تكنولوجيا المعلومات في الكلية او الواصل مع عن طريق الواتساب (⁦+964 780 271 4344⁩).', 'Where can I get the university email?', 'You can review the Department of Information and Information Technology in the college or communicate with me via WhatsApp (+964 780 271 4344).', '2021-08-31 15:05:41', '2021-08-31 15:05:41', 0),
(10, 'اين اجد عنوان الكلية', '{\"ops\":[{\"insert\":\"في صفحة تواصل معنا\\n\"}]}', 'where to find collage location?', '{\"ops\":[{\"insert\":\"in contact us pages\\n\"}]}', '2021-09-02 08:00:12', '2021-09-02 08:06:05', 0),
(11, 'تيست', '{\"ops\":[{\"insert\":\"تيست تيست\\n\"}]}', 'test', '{\"ops\":[{\"insert\":\"test test\\n\"}]}', '2021-09-02 12:30:13', '2021-09-02 12:30:13', 0),
(12, 'سشسبصثقبرؤ', 'شسيصثبئء', 'sadcwerx', 'sdwerdfas', '2021-09-04 16:03:22', '2021-09-04 16:03:22', 0),
(13, '،تلالشه9سعيءىمة', 'سينيت9ن', 'kjufmu', 'kjndfcwth', '2021-09-04 16:03:45', '2021-09-04 16:03:45', 0),
(14, 'sdcvfewrtfsdc', 'scdrwefsd', 'sdcfwrwe', 'sdcwe4rfsdc', '2021-09-04 16:03:55', '2021-09-04 16:03:55', 0),
(15, 'asdczxcqwd', 'qewderdfd', 'sdfecxfref', 'wef43rfsd', '2021-09-04 16:04:08', '2021-09-04 16:04:08', 0),
(16, 'dscsdjcyb', 'UB78GK HLKN', 'ujhxas7b', 'LKHU8SXCSL', '2021-09-04 16:04:26', '2021-09-04 16:04:26', 0),
(17, 'ADSCWRFDSZ', 'ASDW3DC', 'ADW3ERASC', 'ASDEWDFDWF', '2021-09-04 16:04:38', '2021-09-04 16:04:38', 0);
...
(2, NULL, 'galleries/E0B9AVD07Oa0ZWAOnjtgmw4lbMlzN59Twa3zlOOo.jpg', '2021-09-07 07:57:24', '2021-09-07 07:57:24', 0),
(3, 'testdfgdfgdfg', NULL, '2021-09-07 07:57:35', '2021-09-07 07:57:35', 0),
(4, 'testdfgdfgdfg', NULL, '2021-09-07 10:59:51', '2021-09-07 10:59:51', 0),
(5, 'https://www.youtube.com/watch?v=1FVpkxQeUjo', NULL, '2021-09-07 12:48:18', '2021-09-07 12:48:18', 0);
...
CREATE TABLE `international_rankings` (
  `id` int NOT NULL,
  `ar_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `en_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `image` varchar(255) DEFAULT NULL,
...
(2, 'asdsad', 'test', NULL, NULL, NULL, NULL, 'test', 0, NULL, 2, '2021-07-30 05:11:56', 0),
(3, 'web developer', 'full-stack', NULL, NULL, NULL, NULL, 'html, css,js,vuejs,php,laravel', 0, NULL, 2, '2021-08-15 11:20:46', 0),
(7, 'مبرمج لارافل', '{\"ops\":[{\"insert\":\"مطور برامجيات يستطيع العمل على الفريمورك لارفل مع خبرة ٥ سنوات \\nيجب ان تتوفر فيه هذه البيانات \\nمونرتزادلذبي\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"نتالدذبيط\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"متناتلبذطي\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"خهتاعلغبذط\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"ختهاعلدذ\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"}]}', 'LARAVEL DEPELOPER', '{\"ops\":[{\"insert\":\"Software developer who can work on Laval framework with 5 years experience\\n\\nThis data must be available\\n;nbuhyvgcfxd\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"dsfgfsdfdf\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"gdssgdgds\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"gsdgsdgsdgs\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"},{\"insert\":\"sgdggsdgsd\"},{\"attributes\":{\"list\":\"ordered\"},\"insert\":\"\\n\"}]}', 'مطور برامجيات يستطيع العمل على الفريمورك لارفل مع خبرة ٥ سنوات', 'Software developer who can work on Laval framework with 5 years experience', '{\"ops\":[{\"insert\":\"لديه القدر على العمل تحت ضغط العمل\\n\\n\"}]}', 1, NULL, 12, '2021-08-25 10:48:34', 0),
(8, 'سيبيسب', 'شيشسيشسي', 'test', 'testtestetstetstetstets', 'شسيسشيس', 'testtestetstetstetstets', 'test', 0, 'imageJobs/KWMOo0XybnE6YF94G15SCJ4MJKhZZ75U2v2eVGYd.jpg', 2, '2021-08-29 16:11:00', 0),
(9, 'سيبيسب', 'شيشسيشسي', 'test', 'testtestetstetstetstets', 'شسيسشيس', 'testtestetstetstetstets', 'test', 0, 'imageJobs/3ZIsnCio2sG2S04ymCBo0vZS0QFGPhjbqzHdaODl.jpg', 12, '2021-08-29 16:12:02', 0),
(10, 'التنايبن بالىبيال', '{\"ops\":[{\"insert\":\"قاباهل لخلخقلﻻقثل\\t\\n\"}]}', 'ghruig groigreog regoreng', '{\"ops\":[{\"insert\":\"uirhriugbrg rgoiregnrnegbr\\n\"}]}', 'لىقثلىقلقثلىق قثلقثهخلىقثلقث لقثلخهق', 'gnorgr grgoirgnrg rgrgr', '{\"ops\":[{\"insert\":\"idbiuger guioewgbewge\\n\"}]}', 1, 'imageJobs/0vix9BJ9iFjG3WvVRtHGNh65m35y3KGVpZYDLwwz.jpg', 12, '2021-08-30 08:35:56', 0),
(11, 'مهندس مدني', '{\"ops\":[{\"insert\":\"تعلن كلية النسور الجامعة عن حاجتها الى مهندس مدني عدد ٢ على ان لا تقل خبرته عن ٣ سنوات \\nعلى الراغبين بالتقديم لشغل هذه الوظيفة ارسال معلوماتهم والسيرة الذاتية  و سيتم التواصل معه .\\n\"}]}', 'Civil Engineer', '{\"ops\":[{\"insert\":\"Al-Nisour University College announces its need for a civil engineer number 2, provided that his experience is not less than 3 years.\\nThose wishing to apply for this position should send their information and CV and we will contact him.\\n\"}]}', 'تعلن كلية النسور الجامعة عن حاجتها الى مهندس مدني .', 'Al-Nisour University College announces its need for a civil engineer', 'undefined', 1, 'imageJobs/9Ek8g6fk0gUV7tJAHYf3LReRcEo92FoXepVx9HhH.jpg', 12, '2021-08-31 17:40:48', 0),
(12, 'شبكة0ه9ؤةه', 'undefined', 'asdfteyv', 'undefined', 'شششششششششش', 'sssssss', 'undefined', 0, 'imageJobs/mOXzNQRgbDzOH7XZlpLFELj2XCsXJud1ss97Vdom.jpg', 12, '2021-09-04 15:57:35', 0);
...
CREATE TABLE `job_applications` (
  ...
  `graguation` varchar(255) NOT NULL,
  `accurate_specialty` varchar(255) NOT NULL,
...
CREATE TABLE `lectures` (
  `id` int NOT NULL,
  `en_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(1, 'العلوم', NULL, 1, '2021-09-04 08:59:43', '2021-09-04 09:24:19', 0),
(7, 'phesicals', 'الفيزياء', 1, '2021-09-07 07:11:33', '2021-09-07 07:11:33', 0),
(8, 'phesicals', 'الفيزياء', 1, '2021-09-07 07:11:46', '2021-09-07 07:11:46', 0),
(9, 'phesicals', 'الفيزياء', 1, '2021-09-07 07:11:56', '2021-09-07 07:11:56', 0),
(10, 'phesicals', 'الفيزياء', 1, '2021-09-07 08:38:25', '2021-09-07 08:38:25', 0),
(11, 'test', 'test', 7, '2021-09-07 08:40:57', '2021-09-07 08:40:57', 0),
(12, 'phesicals', 'تيست', 1, '2021-09-07 08:46:27', '2021-09-07 08:46:27', 0);
...
--
-- Dumping data for table `presentation_forms`
--

INSERT INTO `presentation_forms` (`id`, `name`, `phone`, `email`, `file_cv`, `job_id`, `created_at`, `is_deleted`) VALUES
(6, 'احمد رائد محمد', '0289777287122', 'ahmed@nuc.edu.iq', 'userCv/Sf35jNv7992JHQDs2rQZIjnhFO9E9cAdmFlZ1Ph6.pdf', 7, '2021-08-29 06:41:52', 0);
...
INSERT INTO `since_departments` (`id`, `ar_name`, `en_name`, `link`, `created_at`, `is_deleted`) VALUES
(1, 'قسم علوم الحاسوب', NULL, NULL, '2021-07-30 02:02:50', 1),
(2, 'قسم علوم الحاسوب', NULL, NULL, '2021-07-30 02:06:02', 1),
(3, 'هندسة برامجيات', NULL, NULL, '2021-07-30 02:06:06', 1),
(4, 'قسم هندسة الميكانيك2', NULL, NULL, '2021-08-14 13:36:09', 1),
(5, 'هندسة', 'Engineering', NULL, '2021-08-22 09:36:30', 1),
(6, 'قسم تجريبي', 'test department', NULL, '2021-08-22 11:05:26', 1),
(7, 'قسم الصيدلة', 'Pharmacy Department', NULL, '2021-08-24 15:26:08', 1),
(8, 'قسم تقنيات التخدير', 'Department of Anesthesia', NULL, '2021-08-24 15:27:08', 1),
(9, 'قسم تقنيات الاشعة و السونار', 'Department of X-rays and sonar', NULL, '2021-08-24 15:28:49', 1),
(10, 'التربية البدنية و علوم الرياضة', 'Physical education and sports science', NULL, '2021-08-24 15:30:09', 0),
(11, 'قسم اللغة الانكليزية', 'English Department', NULL, '2021-08-24 15:30:46', 0),
(12, 'قسم القانون', 'Law Department', NULL, '2021-08-24 15:31:51', 0),
(13, 'قسم ادارة الاعمال', 'Business Management', NULL, '2021-08-24 15:33:01', 0),
(15, 'تقنيات الاشعة و السونار', 'Department of X-rays and sonar', NULL, '2021-08-24 15:34:39', 0),
(16, 'قسم تقنيات التخدير', 'Department of Anesthesia techniques', NULL, '2021-08-24 15:35:17', 0),
(17, 'قسم تقنيات المختبرات الطبية', 'Medical Laboratory Technologies', NULL, '2021-08-24 15:35:53', 0),
(18, 'قسم الصيدلة', 'Pharmacy Department', NULL, '2021-08-25 05:54:31', 0),
(19, 'قسم تجريبي', 'test department', NULL, '2021-08-25 07:16:05', 1),
(20, 'قسم تجريبي', 'test section', NULL, '2021-08-25 07:58:02', 1),
(21, 'قسم تجريبي', 'test department', NULL, '2021-08-25 08:01:55', 1),
(22, 'ikhfioedh`', 'idghgho', NULL, '2021-08-25 08:39:17', 1),
(23, 'ter', 'trtrtrt', NULL, '2021-08-25 08:44:08', 1),
(26, 'هندسة تقنيات الحاسبات', 'Computing Technologies Engineering', NULL, '2021-08-30 09:29:33', 0),
(27, 'قسم علوم الحاسوب', 'uirfhuurhg roig', 'www.example.com', '2021-09-04 14:40:04', 0),
(28, '2تيست', 'test2', 'www.google.iq', '2021-09-04 14:44:20', 0);
...
(1, 'المرحلة الثانية', '', 10, '2021-09-04 07:52:40', '2021-09-04 08:15:10', 0),
(2, 'المرخلة الاولى', '', 10, '2021-09-04 12:10:00', '2021-09-04 12:10:00', 0),
(6, 'fourth stage', 'المرحلة الرابعة', 28, '2021-09-05 15:06:34', '2021-09-07 06:35:30', 0),
(7, 'third stage', 'المرحلة الثالثة', 28, '2021-09-07 06:34:59', '2021-09-07 06:34:59', 0);
...
(9, 'ASD23D', 'QDWDASC', '1821', 28, '2021-09-04 16:05:08', 0);
...
(21, 20, 6, '2021-08-21 09:29:36', 0),
(24, 24, 15, '2021-08-24 13:18:54', 0),
...
(67, 'ؤلالبابلا', 'testttttt', 'ali', 'dsfssdffsdfs', 'test@gmail', 'يسبيسيسب', NULL, NULL, 'شسيشسي', 'asdas', 'يسشسيشسي', 'asdas', NULL, 'EnTeacherCv/KwwaA857iYWVFt7sQ1nkTpKau6688dHSvkQde2zP.png', 11, 0, '2021-09-04 11:59:36', 0),
(68, 'ؤلالبابلا', 'testttttt', 'ali', 'dsfssdffsdfs', 'test@gmail', 'يسبيسيسب', 'techerImage/ZsQA3R6ITrBxvAG2SkqGqHT9hqrEfgE72ByNMdXN.jpg', NULL, 'شسيشسي', 'asdas', 'يسشسيشسي', 'asdas', 'TeacherCv/Hr1JjeP2awUznBjSsnie2bNGjITYsxxst4jPfw8D.png', 'EnTeacherCv/jwTcOaecNBiOZhPl6z6KngR8bxc163jt1HUgC4SL.png', 11, 0, '2021-09-04 12:00:19', 0),
